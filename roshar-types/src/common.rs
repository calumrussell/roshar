...
#[derive(Clone, Debug, Serialize, clickhouse::Row)]
...
impl WriteToClickHouse for LocalOrderBook {
    fn table_name() -> &'static str {
        "crypto.local_order_books"
    }
    ...
    async fn insert_into_clickhouse(
        ...
        let mut insert = client.insert(Self::table_name())?;
...
impl WriteToClickHouse for TradeData {
    fn table_name() -> &'static str {
        "crypto.trades_daily"
    }
...
impl WriteToClickHouse for DepthUpdateData {
    fn table_name() -> &'static str {
        "crypto.depth_updates_daily"
    }
...
impl WriteToClickHouse for DepthSnapshotData {
    fn table_name() -> &'static str {
        "crypto.depth_snapshots_daily"
    }
...
pub trait WriteToClickHouse: std::fmt::Debug + Send + Sync {
    fn table_name() -> &'static str;
    fn insert_into_clickhouse(
        &self,
        client: &Client,
